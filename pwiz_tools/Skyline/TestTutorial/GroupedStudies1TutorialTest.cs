        ...
        private static void TestApplyToAll()
        {
            ...
            RunUI(() =>
            {
                ...
                PeakMatcherTestUtil.VerifyPeaks(MakeVerificationDictionary(
                    ...
                    18.84278, 18.35188, 18.72457, 18.80247, 18.57477, 18.30993), IsRecordMode);
            });
            RunUI(() =>
            {
                ...
                PeakMatcherTestUtil.VerifyPeaks(MakeVerificationDictionary(
                    ...
                    22.85375, 23.04702, 22.85068, 22.88932, 22.70258, 23.19258), IsRecordMode);
            });
            // Apply to subsequent
            RunUI(() =>
            {
                ...
                PeakMatcherTestUtil.VerifyPeaks(MakeVerificationDictionary(
                    ...
                    23.05053, 24.79552, 25.24442, 23.38800, 25.08665, 24.63885), IsRecordMode);
            });
            RunUI(() =>
            {
                ...
                PeakMatcherTestUtil.VerifyPeaks(MakeVerificationDictionary(
                    ...
                    17.20048, 16.88772, 16.51452, 17.14997, 17.04057, 16.47637), IsRecordMode);
            });
            ...
            RunUI(() =>
            {
                ...
                PeakMatcherTestUtil.VerifyPeaks(MakeVerificationDictionary(
                    ...
                    13.09430, 13.06082, 13.16077, 13.12740, 13.12707, 13.09500), IsRecordMode);
            });
            RunUI(() =>
            {
                ...
                PeakMatcherTestUtil.VerifyPeaks(MakeVerificationDictionary(
                    ...
                    13.42930, 13.36232, 13.42877, 13.42890, 13.39507, 13.43000), IsRecordMode);
            });
            RunUI(() =>
            {
                ...
                PeakMatcherTestUtil.VerifyPeaks(MakeVerificationDictionary(
                    ...
                    13.73080, 13.52982, 13.69677, 13.83090, 13.56257, 13.76500), IsRecordMode);
            });
